...
const Visa = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Coming Soon */}
      <div className="relative min-h-[420px] bg-gradient-secondary flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 animate-fade-in">
          ...
          <p className="mt-3 text-lg text-white/80 max-w-md mx-auto">
            Visa assistance services are under development. Hassle-free
            processing coming your way!
          </p>
          <Link
            to="/"
